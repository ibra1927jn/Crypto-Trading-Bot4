...
class TestConfigDefaults:
    ...
    def test_symbol_is_string(self) -> None:
        """SYMBOL is stored as a string."""
        assert isinstance(Config.SYMBOL, str)

    def test_indicators_config_has_rsi(self) -> None:
    ...
    def test_ai_config_keys(self) -> None:
